...
function adicionarAmigo() {
    ...
    if (amigo !== "" && amigo !== undefined && isNaN(amigo)) {
...
function sortearAmigo() {
    let numeroIndice = gerarNumero();
    let escolhido = listaAmigos[numeroIndice];
    let mensagemFinal = `O amigo secreto sorteado é: ${escolhido}`;
